...
def main():
    ...
    seqNum = 100000
    seqLen = 100
    output_dir = f"/Kattn-sim-dev/resources/markov_first_4.fa"
    first_p = {'A': 0.4, 'C': 0.1, 'G': 0.1, 'T': 0.4}
    # other_order_trans = [
    #     {'A': {'A': 0.7, 'C': 0, 'G': 0.3, 'T': 0},
    #      'C': {'A': 0, 'C': 0.7, 'G': 0, 'T': 0.3},
    #      'G': {'A': 0, 'C': 0.3, 'G': 0.7, 'T': 0},
    #      'T': {'A': 0, 'C': 0.7, 'G': 0, 'T': 0.3}},
    #     {'A': {'A': 0.7, 'C': 0, 'G': 0, 'T': 0.3},
    #      'C': {'A': 0, 'C': 0.7, 'G': 0.3, 'T': 0},
    #      'G': {'A': 0, 'C': 0, 'G': 0, 'T': 0.3},
    #      'T': {'A': 0.3, 'C': 0, 'G': 0.7, 'T': 0}},
    #     {'A': {'A': 0.7, 'C': 0, 'G': 0.3, 'T': 0},
    #      'C': {'A': 0.7, 'C': 0, 'G': 0, 'T': 0.3},
    #      'G': {'A': 0, 'C': 0.7, 'G': 0.3, 'T': 0},
    #      'T': {'A': 0, 'C': 0.3, 'G': 0, 'T': 0.7}},
    #     {'A': {'A': 0, 'C': 0, 'G': 0.7, 'T': 0},
    #      'C': {'A': 0.7, 'C': 0.3, 'G': 0, 'T': 0},
    #      'G': {'A': 0, 'C': 0.7, 'G': 0, 'T': 0},
    #      'T': {'A': 0.7, 'C': 0, 'G': 0, 'T': 0.3}},
    #     {'A': {'A': 0, 'C': 0, 'G': 0.3, 'T': 0.7},
    #      'C': {'A': 0, 'C': 0, 'G': 0.7, 'T': 0},
    #      'G': {'A': 0, 'C': 0.3, 'G': 0.7, 'T': 0},
    #      'T': {'A': 0.7, 'C': 0.3, 'G': 0, 'T': 0}},
    #     {'A': {'A': 0, 'C': 0.7, 'G': 0.3, 'T': 0},
    #      'C': {'A': 0, 'C': 0.3, 'G': 0, 'T': 0.7},
    #      'G': {'A': 0, 'C': 0.3, 'G': 0.7, 'T': 0},
    #      'T': {'A': 0, 'C': 0.7, 'G': 0, 'T': 0}},
    #     {'A': {'A': 0.3, 'C': 0, 'G': 0, 'T': 0.7},
    #      'C': {'A': 0.7, 'C': 0.3, 'G': 0, 'T': 0},
    #      'G': {'A': 0.7, 'C': 0, 'G': 0, 'T': 0.3},
    #      'T': {'A': 0, 'C': 0.7, 'G': 0, 'T': 0.3}},
    #     {'A': {'A': 0, 'C': 0, 'G': 0.7, 'T': 0.3},
    #      'C': {'A': 0.3, 'C': 0.7, 'G': 0, 'T': 0},
    #      'G': {'A': 0, 'C': 0.7, 'G': 0, 'T': 0.3},
    #      'T': {'A': 0, 'C': 0, 'G': 0.3, 'T': 0.7}},
    #     {'A': {'A': 0, 'C': 0, 'G': 0.7, 'T': 0},
    #      'C': {'A': 0, 'C': 0.7, 'G': 0, 'T': 0.3},
    #      'G': {'A': 0.7, 'C': 0, 'G': 0.3, 'T': 0},
    #      'T': {'A': 0, 'C': 0.3, 'G': 0.7, 'T': 0}}
    # ]
    other_order_trans = [
    ...
    other_order_trans = [
        {'A': {'A': 0.5, 'C': 0.5, 'G': 0.5, 'T': 0},
         'C': {'A': 0, 'C': 0.5, 'G': 0, 'T': 0.5},
         'G': {'A': 0, 'C': 0.5, 'G': 0.5, 'T': 0},
         'T': {'A': 0, 'C': 0.5, 'G': 0.5, 'T': 0.5}},
        {'A': {'A': 0.5, 'C': 0, 'G': 0.5, 'T': 0.5},
         'C': {'A': 0, 'C': 0.5, 'G': 0.5, 'T': 0},
         'G': {'A': 0, 'C': 0.5, 'G': 0.5, 'T': 0.5},
         'T': {'A': 0.5, 'C': 0.5, 'G': 0.5, 'T': 0}},
        {'A': {'A': 0.5, 'C': 0, 'G': 0.5, 'T': 0},
         'C': {'A': 0.5, 'C': 0, 'G': 0.5, 'T': 0.5},
         'G': {'A': 0, 'C': 0.5, 'G': 0.5, 'T': 0},
         'T': {'A': 0, 'C': 0.5, 'G': 0, 'T': 0.5}},
        {'A': {'A': 0.5, 'C': 0.5, 'G': 0.5, 'T': 0},
         'C': {'A': 0.5, 'C': 0.5, 'G': 0, 'T': 0},
         'G': {'A': 0, 'C': 0.5, 'G': 0, 'T': 0.5},
         'T': {'A': 0.5, 'C': 0, 'G': 0, 'T': 0.5}},
        {'A': {'A': 0, 'C': 0.5, 'G': 0.5, 'T': 0.5},
         'C': {'A': 0.5, 'C': 0, 'G': 0.5, 'T': 0},
         'G': {'A': 0, 'C': 0.5, 'G': 0.5, 'T': 0.5},
         'T': {'A': 0.5, 'C': 0.5, 'G': 0, 'T': 0}},
        {'A': {'A': 0, 'C': 0.5, 'G': 0.5, 'T': 0},
         'C': {'A': 0, 'C': 0.5, 'G': 0, 'T': 0.5},
         'G': {'A': 0.5, 'C': 0.5, 'G': 0.5, 'T': 0},
         'T': {'A': 0, 'C': 0.5, 'G': 0.5, 'T': 0}},
        {'A': {'A': 0.5, 'C': 0.5, 'G': 0, 'T': 0.5},
         'C': {'A': 0.5, 'C': 0.5, 'G': 0, 'T': 0},
         'G': {'A': 0.5, 'C': 0, 'G': 0.5, 'T': 0.5},
         'T': {'A': 0, 'C': 0.5, 'G': 0, 'T': 0.5}},
        {'A': {'A': 0, 'C': 0.5, 'G': 0.5, 'T': 0.5},
         'C': {'A': 0.5, 'C': 0.5, 'G': 0, 'T': 0},
         'G': {'A': 0, 'C': 0.5, 'G': 0.5, 'T': 0.5},
